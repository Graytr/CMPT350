...
if ( isset($_REQUEST['newBuildingName']) || isset($_REQUEST['curBuildingName']) || isset($_REQUEST['deleteBuildingName']) ){ 
	...
	if ( isset($_REQUEST['newBuildingName']) ) {
		//Creates the table for a new building		
		...
		$sql= " INSERT INTO building(buildingName, cityName, address, postalCode, numberRooms) VALUES ('$newBuildingName','$newCityName','$newAddress','$newPostalCode','$newNumRooms')";
	...
	if ( isset($_REQUEST['curBuildingName']) ) {
	...
	if ( isset($_REQUEST['deleteBuildingName']) ) {
